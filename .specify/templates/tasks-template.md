...
- [ ] TXXX [P] Additional unit tests to achieve ≥80% coverage in tests/unit/
- [ ] TXXX [P] Performance testing and validation against constitution benchmarks
- [ ] TXXX [P] Accessibility testing (WCAG 2.1 AA compliance) and UX consistency review
